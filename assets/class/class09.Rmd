---
title: "Class 08: Logistic Regression"
...
for (iter in (seq_len(n_iter) - 1))
{
  ...
  grad <- NULL # put your formula for the gradient in here
...
"five times faster", but you'll probably see instead that it instead gets
stuck.
...
for (iter in (seq_len(n_iter) - 1))
{
  ...
  grad <- NULL # put your formula for the gradient in again
